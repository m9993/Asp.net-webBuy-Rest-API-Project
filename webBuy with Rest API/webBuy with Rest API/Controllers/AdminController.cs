...
namespace webBuy_with_Rest_API.Controllers
{
    ...
    public class AdminController : ApiController
    {
        ...
        [Route("SerachProduct/{searchKey}"), HttpGet]
        ...
        [Route("GetLastAddedProducts/{itemCount}"), HttpGet]
        public IHttpActionResult GetLastAddedProducts(int itemCount)
        {
            return Ok(productRepository.GetLastAddedProducts().Take(itemCount));
        }
